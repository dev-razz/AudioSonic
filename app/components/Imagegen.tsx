  ...
  return (
    <div className="w-1/2 flex flex-col justify-center items-center">
      <div className="grid grid-cols-2 gap-3 p-4">
        <button className="btn btn-neutral ml-3" onClick={generateImages} disabled={isLoading || !isTransSet}>
          Generate Images Stability Ai
        </button>
        <button className="btn btn-neutral ml-3" onClick={generateDalleImages} disabled={isLoading || !isTransSet}>
